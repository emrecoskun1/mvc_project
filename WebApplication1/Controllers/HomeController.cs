...
public class HomeController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            double usdRate = Convert.ToDouble(currencyData.USD.Satis);
            double eurRate = Convert.ToDouble(currencyData.EUR.Satis);
            double gbpRate = Convert.ToDouble(currencyData.GBP.Satis);
            double chfRate = Convert.ToDouble(currencyData.CHF.Satis);
            double qarRate = Convert.ToDouble(currencyData.QAR.Satis);
